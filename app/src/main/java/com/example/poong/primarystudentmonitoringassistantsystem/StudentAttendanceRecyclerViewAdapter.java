 ...
 */
public class StudentAttendanceRecyclerViewAdapter extends RecyclerView.Adapter<StudentAttendanceRecyclerViewAdapter.ViewHolder> {

    private final List<Student> mValues;


    public StudentAttendanceRecyclerViewAdapter(List<Student> items) {
        mValues = items;
